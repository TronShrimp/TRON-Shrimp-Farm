...
function refreshData(){
    ...
    contractBalance(function(result){
        ...
        balanceElem.textContent = 'Contract Balance: ' + stripDecimals(rawStr, 1) + ' TRX';
    });
    ...
    calculateEggSell(86400,function(sun){
        devFee(sun,function(fee){
            ...
            sellsforexampledoc.textContent='1 egg sells for ' + tronWeb.fromSun(sun) + ' TRX';
        });
    });
...
function formatTrxValue(trxstr){
    ...
    // parseFloat(parseFloat(trxstr).toFixed(10));
}
